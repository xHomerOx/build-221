...
class AuditoriasHeader extends Component {
    render() {
        return (
...
class AuditoriasTitle extends Component {
    render() {
        return (
            <p className="list-group-item-dark text-center text-white py-3 my-1">Auditorías en video</p>
        )
    }
}


export class AuditoriasBody extends Component {
    ...
    componentDidMount = () => {
     fetch("https://www.agn.gob.ar/reactjs/informes-video")
                                ...
                                <li key={item.nid} className="list-group-item border-0">
                                    <div className="wrapper">
                                        <div className="Auditorias">
                                            <Link to={{pathname: `/auditoria/${item.nid}`, state: { params: {id: `${item.id}`, nid: `${item.nid}`} }}} className="App-link">
...
export class Auditorias extends Component {
