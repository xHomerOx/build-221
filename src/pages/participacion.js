...
class ParticipacionHeader extends Component {
    render() {
        return (
...
class ParticipacionTitle extends Component {
    render() {
        return (
            <p className="list-group-item-dark text-center text-white py-3 my-1">Participacion Ciudadana</p>
        )
    }
}


export class ParticipacionBody extends Component {
    ...
    componentDidMount = () => {
     fetch("https://www.agn.gob.ar/reactjs/participacion")
                                ...
                                <li key={item.nid} className="list-group-item border-0">
                                    <div className="wrapper">
                                        <div className="participacion">
                                            <Link to={{pathname: `/participacion-node/${item.nid}`, state: { params: {id: `${item.id}`, nid: `${item.nid}`} }}} className="App-link">
...
export class Participacion extends Component {
