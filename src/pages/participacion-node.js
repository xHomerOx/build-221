...
class ParticipacionNode extends Component {
  ...
  componentDidMount(){
    ...
    fetch(`https://www.agn.gob.ar/reactjs/node/participacion_ciudadana/${id}?include=field_imagen`)
...
export default ParticipacionNode;