...
class AulaHeader extends Component {
    render() {
        return (
...
class AulaTitle extends Component {
    render() {
        return (
            <p className="list-group-item-dark text-center text-white py-3 my-1">Aula AGN</p>
        )
    }
}


export class AulaBody extends Component {
    ...
    componentDidMount = () => {
     fetch("https://www.agn.gob.ar/reactjs/aula")
                        ...
                        return (
                                <li key={item.nid} className="list-group-item border-0">
                                    <div className="wrapper">
                                        <div className="aula">
                                            <Link to={{pathname: `/aula-node/${item.nid}`, state: { params: {id: `${item.id}`, nid: `${item.nid}`} }}} className="App-link">
...
export class Aula extends Component {
