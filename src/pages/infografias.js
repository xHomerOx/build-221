...
class InfografiasHeader extends Component {
    render() {
        return (
...
class InfografiasTitle extends Component {
    render() {
        return (
            <p className="list-group-item-dark text-center text-white py-3 my-1">Infografias</p>
        )
    }
}


export class InfografiasBody extends Component {
    ...
    componentDidMount = () => {
     fetch("https://www.agn.gob.ar/reactjs/infografias")
                                ...
                                <li key={item.nid} className="list-group-item border-0">
                                    <div className="wrapper">
                                        <div className="infografias">
                                            <Link to={{pathname: `/infografia/${item.nid}`, state: { params: {id: `${item.id}`, nid: `${item.nid}`} }}} className="App-link">
...
export class Infografias extends Component {
