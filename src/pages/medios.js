...
class MediosHeader extends Component {
    render() {
        return (
...
class MediosTitle extends Component {
    render() {
        return (
            <p className="list-group-item-dark text-center text-white py-3 my-1">La AGN en los Medios</p>
        )
    }
}

export class MediosBody extends Component {
    ...
    componentDidMount = () => {
     fetch("https://www.agn.gob.ar/reactjs/medios")
                                ...
                                <li key={item.nid} className="list-group-item border-0">
                                    <div className="wrapper">
                                        <div className="medios">
                                            <Link to={{pathname: `/medio/${item.nid}`, state: { params: {id: `${item.id}`, nid: `${item.nid}`} }}} className="App-link">
